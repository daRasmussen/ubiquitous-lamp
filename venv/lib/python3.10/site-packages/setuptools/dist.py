...
class Distribution(_Distribution):
    ...
    account.management.commands that add or remove packages, modules, extensions, and so on from
    the distribution.
    """
    ...
    def _setuptools_commands(self):
        try:
            ...
            return list(dist.get_entry_map('distutils.account.management.commands'))
    ...
    def get_command_class(self, command):
        ...
        eps = pkg_resources.iter_entry_points('distutils.account.management.commands', command)
        for ep in eps:
            ep.require(installer=self.fetch_build_egg)
    ...
    def print_commands(self):
        for ep in pkg_resources.iter_entry_points('distutils.account.management.commands'):
            if ep.name not in self.cmdclass:
                # don't require extras as the account.management.commands won't be invoked
                cmdclass = ep.resolve()
    ...
    def _parse_command_opts(self, parser, args):
        ...
        # Handle account.management.commands that want to consume all remaining arguments
